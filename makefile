...
kernel: $(OBJDIR)/kasm.o $(OBJDIR)/kc.o $(OBJDIR)/vga.o $(OBJDIR)/idt.o $(OBJDIR)/pong.o
	$(LD) -m elf_i386 -T link.ld -o kernel $(OBJDIR)/kasm.o $(OBJDIR)/kc.o $(OBJDIR)/vga.o $(OBJDIR)/idt.o $(OBJDIR)/pong.o
